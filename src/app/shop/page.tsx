...
export default async function Shop({
  ...
  const eras = [
    ...new Set(allItems.map((i) => i.era).filter(Boolean)),
  ] as string[];
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16">
      ...
      <header className="mb-10 text-center">
        <p className="text-xs tracking-[0.3em] text-brass">COLLECTION</p>
      ...
      >
        <label className="flex flex-col text-xs text-stone-500">
          ...
          <select
            ...
            className="mt-1 rounded border border-stone-300 bg-white px-3 py-2 text-sm text-stone-800"
          >
